...
INSERT INTO customer (name, address, contact_name, contact_email, contact_phone, active, created_at, updated_at, version) VALUES
    ('Demo Solar Customer LLC', '1 Solar Way, Austin, TX', 'Jordan Lee', 'jordan.lee@demo-customer.example', '512-555-0100', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
...
INSERT INTO supplier (name, country_of_origin, feoc_status, feoc_notes, material_info, active, created_at, updated_at, version) VALUES
    ('Demo Cell Supplier Inc', 'United States', 'PASS', 'Placeholder seed entry.', 'Monocrystalline PERC cells', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
