...
INSERT INTO app_role (name, description, created_at, updated_at, version) VALUES
    ('FINANCE',    'Upload invoices; view credits & reports',            SYSUTCDATETIME(), SYSUTCDATETIME(), 0),
    ('LOGISTICS',  'Upload POD; view shipments',                          SYSUTCDATETIME(), SYSUTCDATETIME(), 0),
    ('PRODUCTION', 'Traceability; view production data',                  SYSUTCDATETIME(), SYSUTCDATETIME(), 0),
    ('MANAGEMENT', 'Dashboard; analytics & reports (read-only)',          SYSUTCDATETIME(), SYSUTCDATETIME(), 0),
    ('ADMIN',      'User management; master data; full access',          SYSUTCDATETIME(), SYSUTCDATETIME(), 0);
...
INSERT INTO app_user (full_name, email, entra_object_id, password_hash, active, created_at, updated_at, version) VALUES
    ('Demo Admin', 'demo.admin@example.com', NULL, '$2b$10$UsbI7e4EIWwcZ5y12f0W8eiawpgugFKE6rYCdQVv/fnIaxLudPUL6', 1, SYSUTCDATETIME(), SYSUTCDATETIME(), 0);

INSERT INTO user_role_assignment (user_id, role_id, assigned_at, assigned_by_user_id, created_at, updated_at, version)
SELECT u.id, r.id, SYSUTCDATETIME(), NULL, SYSUTCDATETIME(), SYSUTCDATETIME(), 0
...
INSERT INTO credit_rate (component_type, rate_per_watt, effective_from, effective_to, created_at, updated_at, version) VALUES
    ('SOLAR_CELL',   0.04, '2023-01-01', NULL, SYSUTCDATETIME(), SYSUTCDATETIME(), 0),
    ('SOLAR_MODULE', 0.07, '2023-01-01', NULL, SYSUTCDATETIME(), SYSUTCDATETIME(), 0);
...
INSERT INTO feoc_list_entry (entry_type, name, status, notes, effective_from, created_at, updated_at, version) VALUES
    ('COUNTRY', 'China',       'PROHIBITED', 'Placeholder seed entry - confirm against current FEOC guidance.', '2023-01-01', SYSUTCDATETIME(), SYSUTCDATETIME(), 0),
    ('COUNTRY', 'North Korea', 'PROHIBITED', 'Placeholder seed entry - confirm against current FEOC guidance.', '2023-01-01', SYSUTCDATETIME(), SYSUTCDATETIME(), 0),
    ('COUNTRY', 'Russia',      'PROHIBITED', 'Placeholder seed entry - confirm against current FEOC guidance.', '2023-01-01', SYSUTCDATETIME(), SYSUTCDATETIME(), 0),
    ('COUNTRY', 'Iran',        'PROHIBITED', 'Placeholder seed entry - confirm against current FEOC guidance.', '2023-01-01', SYSUTCDATETIME(), SYSUTCDATETIME(), 0);
